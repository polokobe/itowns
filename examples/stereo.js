/* global itowns, document, renderer, AnaglyphEffect, ParallaxBarrierEffect, StereoEffect */
// # Simple Globe viewer
...
function enableAnaglyph() {
    ...
    _eff = new AnaglyphEffect(globeView.mainLoop.gfxEngine.renderer,
...
function enableParallax() {
    ...
    _eff = new ParallaxBarrierEffect(globeView.mainLoop.gfxEngine.renderer,
        globeView.camera.camera3D);
    enableEffect(_eff);
}
...
function enableStereo() {
    ...
    _eff = new StereoEffect(globeView.mainLoop.gfxEngine.renderer,
        globeView.camera.camera3D);
    enableEffect(_eff);
}
