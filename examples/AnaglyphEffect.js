...
function AnaglyphEffect ( renderer, camera, width, height ) {
/* END CUSTOM ITOWNS */

    // Matrices generated with angler.js https://github.com/tschw/angler.js/
    // (in column-major element order, as accepted by WebGL)

    this.colorMatrixLeft = new itowns.THREE.Matrix3().fromArray( [
    ...
    this.colorMatrixRight = new itowns.THREE.Matrix3().fromArray( [
    ...
    var _renderTargetL = new itowns.THREE.WebGLRenderTarget( width, height, _params );
    var _renderTargetR = new itowns.THREE.WebGLRenderTarget( width, height, _params );
